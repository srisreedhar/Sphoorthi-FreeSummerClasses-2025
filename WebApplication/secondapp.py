...
<p>This is a consulting Firm for tech projects.</p>
<p>we are offering services in AI ML DE DA BBC</p>
...
<section>
  <nav>
    <ul>
      ...
      <li><a href="http://127.0.0.1:5000/aboutus">aboutus</a></li>
      <li><a href="http://127.0.0.1:5000/contactus">contactus</a></li>
    </ul>
  </nav>
...
# @secondapp.route("/services/machinelearning")
# def services_page():
#     return """ Hello All, Services Services"""
